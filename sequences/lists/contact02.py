...
print(f'\nYesterday: {str(yesterday)} all my troubles seemed so far away ')
print('\nOh, I believe in yesterday.\n')
...
"Why don't you like cats? You just don't know how to cook them!"
"You just don't know how to talk to them"