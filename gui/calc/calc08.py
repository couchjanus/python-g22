...
class Calc:
    def __init__(self, master):
        ...
        # создаём виджет
        self.closeButton = Button(master, text='Exit', font='Arial 14', width = 10, bg='red', fg='white', command = lambda:master.quit())
        self.closeButton.grid(row=5, column = 5, sticky=SE)
